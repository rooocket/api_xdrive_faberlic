...
<ul>
    ...
    <li>На каждый токен выдается дневной лимит по смс. Например, у вас ограничение на токен 100 смс в день - неизрасходованный объем не переносится на следующий день и обновляется в 00:00 по МСК</li>
