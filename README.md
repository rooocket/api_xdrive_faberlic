...
пользователь перенаправляется на специальный зашифрованный url, где произойдет автоматическая авторизация пользователя на сайте new.faberlic.com и далее перенравится указанную ссылку.<br>Пример ссылки: https://faberlic.com/index.php?option=com_catalog&view=goods&id=1001312519886&Itemid=2075&lang=ru</li>
